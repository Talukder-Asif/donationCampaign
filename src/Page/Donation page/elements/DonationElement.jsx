...
const DonationElement = ({donatetedCard}) => {
    ...
    return (
        ...
        <figure><img className="w-auto md:w-80" src={donatetedCard.image[0]} alt="Movie"/></figure>
        ...
        <div className="card-actions justify-start">
          ...
          <p style={{color:donatetedCard.colors[1]} } className={` text-base font-semibold `}>${donatetedCard.price}.00</p>
            <div className="card-actions justify-start">
            <Link style={{background:donatetedCard.colors[1]}} className="py-2 px-4 rounded text-white font-semibold btn-primary">View Details</Link>
            </div>
        </div>
        </div>
    );
