...
const CardDetailsPageElement = ({special}) => {
    ...
    return (
        ...
        <div className="relative">
            ...
            <div className="absolute bg-[#0000007e] w-full pl-7 py-7 bottom-0">
                <button onClick={handeldonate} style={{background:special?.colors[1] }} className={`p-3 rounded-md text-white`}><Link>Donate ${special?.price}</Link></button>
            </div>
        </div>
